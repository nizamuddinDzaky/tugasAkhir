...
public class ScanActivity extends AppCompatActivity {
    ...
    QuadrilateralSelectionImageView selectionImageView;
    Button btnScan;
...
//        List<PointF> pointFList = findPoints();
//        selectionImageView.setPoints(pointFList);
    }
    ...
    private List<PointF> findPoints() {
        ...
        Mat image = new Mat();
        Mat orig = new Mat();
        org.opencv.android.Utils.bitmapToMat(getResizedBitmap(bitmap), image);
    ...
    public void scanImage(View view) {
        ...
        List<PointF> pointFS = selectionImageView.getPoints();
